 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 1600, 558 } // Voron Mobius 4 Extruder
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1800, 1800, 80, 1800 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 21.5, -0.6 }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 5), (Y_MAX_POS), 20 }
...
//#define RGBW_LED
  ...
  #define RGB_LED_R_PIN PA2
  #define RGB_LED_G_PIN PE6
  #define RGB_LED_B_PIN PB2
