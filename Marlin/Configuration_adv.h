...
#define SENSORLESS_BACKOFF_MM  { 5, 10 }     // (mm) Backoff from endstops before sensorless homing

#define HOMING_BUMP_MM      { 0, 0, 2 }       // (mm) Backoff from endstops after first bump
#define HOMING_BUMP_DIVISOR { 2, 2, 4 }       // Re-Bump Speed Divisor (Divides the Homing Feedrate)

#define HOMING_BACKOFF_POST_MM { 5, 10, 0 }  // (mm) Backoff from endstops after homing
...
//
  ...
  #define TFT_BTARROWS_COLOR 0xFFFF // 11011 110111 00110 Yellow
  #define TFT_BTOKMENU_COLOR 0x23DF // 00010 100010 11111 Cyan
#endif
