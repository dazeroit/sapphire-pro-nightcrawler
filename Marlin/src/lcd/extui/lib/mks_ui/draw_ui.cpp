...
void gCfgItems_init() {
  ...
  gCfgItems.pausePosZ         = 5;
    ...
    gCfgItems.levelingPos[0][0] = X_MIN_POS + lfrb[0];
    gCfgItems.levelingPos[0][1] = Y_MIN_POS + lfrb[1];
    gCfgItems.levelingPos[1][0] = X_MAX_POS - lfrb[2];
    gCfgItems.levelingPos[1][1] = Y_MIN_POS + lfrb[1];
    gCfgItems.levelingPos[2][0] = X_MAX_POS - lfrb[2];
    gCfgItems.levelingPos[2][1] = Y_MAX_POS - lfrb[3];
    gCfgItems.levelingPos[3][0] = X_MIN_POS + lfrb[0];
    gCfgItems.levelingPos[3][1] = Y_MAX_POS - lfrb[3];
